...
// 2. obj instanceof [VS] typeof 性能对比 => 区别不大
// 3. for in [VS] for of 性能对比 => 区别不大

function isObject(obj) {
  // return (obj && typeof obj === 'object') || typeof obj === 'function';
  return obj instanceof Object;
}
function cloneMap(obj, cache) {
  const _map = new Map();
...
function deepClone(obj, cache = new WeakMap()) {
  ...
  switch (Constructor) {
    ...
    case Map:
      return cloneMap(obj, cache);
    case Set:
      return cloneSet(obj, cache);
    // 3.1 常规对象 Object,Array
    default:
      // 4. 一些特殊情况处理:
      //   4.1 Symbol 作为 key
      ...
      for (const [key, val] of Object.entries(obj)) {
        if (isObject(val)) cloneObj[key] = deepClone(val, cache);
      }
      break;
  }
  return cloneObj;

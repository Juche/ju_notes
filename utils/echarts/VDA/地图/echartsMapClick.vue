<template>
    <v2container :wid="`root`" style="width:100%;height:auto;display:flex;flex-direction:column;justify-content:flex-start;align-items:flex-start;align-content:stretch;align-self:stretch;min-width:50px;">
        <v2-component-echart :wid="`1593658629336`" class="V2Widget" v-initial-style="`position:relative;margin-top:0;margin-bottom:0;margin-left:0;margin-right:0;box-sizing:border-box;flex-grow:\`\`;overflow:hidden;width:1000px;height:800px;animation-duration:1s;`" :configs="option" :is-liquid-fill="false" :is-wordcloud="false" :is-bmap="false" :is-gl="false" :initcb="`echartintcb`" :visible="true">
        </v2-component-echart>
    </v2container>
</template>
<script>
    ...
    export default {
        ...
        data() {
            return {
                'CONTENT': {
                    'structure': {"id":"root","component":"v2Container","direction":"row","layout":[100],"data":{},"children":[{"configs":"${option}","isLiquidFill":false,"isWordcloud":false,"isBmap":false,"isGl":false,"initcb":"echartintcb","visible":true,"__capacity":"1","component":"v2-component-echart","href":"v2-component-echart","children":[],"events":{"_op_componentEchart_chart":{"click":["v2_component_echart_1593659957000"]}},"id":1593658629336,"pid":"root","sizeLocked":{"widthLock":true,"heightLock":false},"animate":["","animated"],"props":["configs","isLiquidFill","isWordcloud","isBmap","isGl","initcb","visible"]}],"events":{}},
                    'forms': []
                },
                /* 版本号，请勿修改 */
                '__VERSION': 3.0
        ...
        'computed': {
            ...
            option() {
                ...
                ctx.$echarts.registerMap('chinaMap', chinaMap);
                ctx.$echarts.registerMap('chinaMapOutline', chinaMapOutline);
                var option = {
        ...
        'methods': {
            /**
             *  v2_component_echart_1593659957000
             *  @param 组件的vue实例 vueIns
             *  @param 事件的event对象 $event
             *  @param 参数 params
             */
            v2_component_echart_1593659957000(vueIns, $event, params) {
                /**
                * 事件绑定在dom上，第一个参数是vue实例。
                * 第二个参数是事件的event对象。
                ...
                **/
                ...
                // console.log('echarts vueIns: ', vueIns)
                // console.log('echarts $event: ', $event)
                // console.log('echarts params: ', params)
                // console.log('echarts ctx.__getVueIns(1593658629336).$refs._op_componentEchart_chart: ', ctx.__getVueIns(1593658629336).$refs._op_componentEchart_chart)
        ...
        mounted() {
            ...
            //     console.log('echarts ctx.__getVueIns(1593658629336): ', ctx.__getVueIns(1593658629336))
            
            //     console.log('echarts ctx.__getVueIns(1593658629336).chart: ', ctx.__getVueIns(1593658629336).chart)
            
            //     ctx.__getVueIns(1593658629336).chart.on('click', function (params) {
            //         console.log(params);
            //     });
            // })
